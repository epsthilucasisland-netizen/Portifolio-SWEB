    ...
    <?php if (!empty($categorias)): ?>
        ...
        <div class="categories-grid">
            ...
            <?php foreach ($categorias as $categoria): ?>
                ...
                <?php
$imagemCategoria = "academia.jpeg";

switch (mb_strtolower($categoria["nome"], "UTF-8")) {
    case "academia":
        $imagemCategoria = "academia.jpeg";
        break;
    ...
    case "acessórios":
    case "acessorios":
        $imagemCategoria = "acessorios.jpeg";
        break;

    case "basquete":
        $imagemCategoria = "basquete.jpeg";
        break;

    case "corrida":
        $imagemCategoria = "corrida.jpeg";
        break;
}
?>
                <a
